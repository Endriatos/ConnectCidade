      ...
      {modalAberto && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl px-8 py-10 w-full max-w-sm text-center mx-4">
            <div className="flex items-center justify-center w-14 h-14 rounded-full bg-[hsl(161,93%,30%)]/10 mx-auto mb-5">
              <svg className="w-7 h-7 text-[hsl(161,93%,30%)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <p className="text-xl font-semibold text-[#171717] tracking-tight">
            ...
            <button
              ...
              className="mt-6 w-full py-3 rounded-xl bg-[hsl(161,93%,30%)] text-white font-medium text-sm hover:bg-[hsl(161,93%,25%)] active:scale-[0.98] transition-all"
            >
              Começar
            </button>
          </div>
